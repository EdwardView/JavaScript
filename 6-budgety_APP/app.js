...
var budgetController = (function(){
	...
	calculateBudget : function(){
		// Calcuate total expense and income
			calculatTotal('exp');
			calculatTotal('inc');
   ...
   return {
	   getInput : function(){
		 ...
		 displayBudget : function(obj){
			 ...
			 document.querySelector(DOMStrings.expenseLabel).textContent = formatNumbers(obj.totalExpense,'exp');
